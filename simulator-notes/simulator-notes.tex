\subsection*{ANNarchy Research Notes}\label{ANNarchy}
...
Though ANNarchy was originally published in 2015 and is outside the last eight-year inclusion window, it remains highly relevant due to its citation record and ongoing development, with version 4.8.1 released in July 2024. It has accumulated over 115 citations, with recent research using ANNarchy as a baseline for new simulator advancements, such as in the PymoNNto and PymoNNtorch projects. This active development and consistent application in current research justify its inclusion in the systematic review as a valuable, flexible tool for constructing complex neural networks.

\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=ANNarchy at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Izhikevich, Leaky Integrate-and-Fire, Hodgkin–Huxley, Equation-based, Rate-coded Leaky Integrator

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Short-Term Plasticity (STP), Equation-based, Rate-coded - Oja, Rate-coded - IBCM, Rate-coded - Hebb  

\textbf{Targeted Hardware:} CPU, GPU 

\textbf{Source Code:} \href{https://github.com/ANNarchy/ANNarchy}{github.com/ANNarchy/ANNarchy}
\end{tcolorbox}
\subsection*{Arbor Research Notes}\label{Arbor}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Arbor at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP)  

\textbf{Targeted Hardware:} CPU, GPU, GPU Cluster 

\textbf{Source Code:} \href{https://github.com/arbor-sim/arbor}{github.com/arbor-sim/arbor}
\end{tcolorbox}
\subsection*{Auryn Research Notes}\label{Auryn}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Auryn at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Adaptive Exponential  Integrate-and-Fire (aEIF), Integrate-and-Fire

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Short-Term Plasticity (STP), Triplet STDP  

\textbf{Targeted Hardware:} CPU 

\textbf{Source Code:} \href{https://github.com/fzenke/auryn}{github.com/fzenke/auryn}
\end{tcolorbox}
\subsection*{BindsNET Research Notes}\label{BindsNET}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=BindsNET at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Izhikevich, Integrate-and-Fire, Leaky Integrate-and-Fire, McCulloch-Pitts

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Reward-Modulated (M-STDP) (R-STDP), Reward-Modulated Elegibility Trace (M-STDP-ET) (R-STDP), Basic Hebbian, ANN-to-SNN Conversion  

\textbf{Targeted Hardware:} CPU, GPU 

\textbf{Source Code:} \href{https://github.com/BindsNET/bindsnet}{github.com/BindsNET/bindsnet}
\end{tcolorbox}
\subsection*{BrainCog Research Notes}\label{BrainCog}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=BrainCog at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Izhikevich, Integrate-and-Fire, Leaky Integrate-and-Fire, Hodgkin–Huxley, Adaptive Exponential  Integrate-and-Fire (aEIF), Multi-compartment

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Basic Hebbian, Short-Term Plasticity (STP), Surrogate Gradient Back Propogation, Reward-Modulated Elegibility Trace (M-STDP-ET) (R-STDP)  

\textbf{Targeted Hardware:} CPU, GPU, FPGA 

\textbf{Source Code:} \href{https://github.com/BrainCog-X/Brain-Cog}{github.com/BrainCog-X/Brain-Cog}
\end{tcolorbox}
\subsection*{BrainPy Research Notes}\label{BrainPy}
...
Despite the documentation providing examples and tutorials for model building, it may be challenging for users outside neuroscience, as the framework appears more focused on brain simulation than brain-inspired AI. BrainPy offers essential components such as mathematical operators, differential equation solvers, and object-oriented JIT compilation, giving users the flexibility to freely define brain dynamics models and achieve high performance without modifying their code. This structure positions BrainPy as a valuable resource for neuroscience applications, emphasizing brain simulation over broader AI applications.

\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=BrainPy at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Hodgkin–Huxley

\textbf{Learning Methods:} Back Propogation Through Time (BPTT), Ridge Regression, FORCE Training (Reservoir Computing)  

\textbf{Targeted Hardware:} CPU, GPU, TPU 

\textbf{Source Code:} \href{https://github.com/brainpy/BrainPy}{github.com/brainpy/BrainPy}
\end{tcolorbox}
\subsection*{Brian2 Research Notes}\label{Brian2}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Brian2 at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Equation-based, Multi-compartment

\textbf{Learning Methods:} Equation-based, Spike Timing Dependant Plasticity (STDP)  

\textbf{Targeted Hardware:} CPU, GPU 

\textbf{Source Code:} \href{https://briansimulator.org/}{briansimulator.org/}
\end{tcolorbox}
\subsection*{Brian2Loihi Research Notes}\label{Brian2Loihi}
...
For smaller models, Brian2Loihi is competitive in performance, making it an excellent tool for prototyping. However, for larger and longer-running models where runtime becomes a limiting factor, the actual Loihi hardware outperforms the emulator. The paper discusses the emulator’s ability to accurately simulate Loihi’s computational unit, including on-chip learning with minimal error due to stochastic rounding, although it highlights that certain discrepancies may arise in more complex simulations.

\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Brian2Loihi at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Equation-based, Spike Timing Dependant Plasticity (STDP)  

\textbf{Targeted Hardware:} CPU, Loihi 

\textbf{Source Code:} \href{https://github.com/sagacitysite/brian2_loihi}{github.com/sagacitysite/brian2\_loihi}
\end{tcolorbox}
\subsection*{BSim Research Notes}\label{BSim}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=BSim at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Static Synapse (No Learning)  

\textbf{Targeted Hardware:} CPU, GPU, GPU Cluster 

\textbf{Source Code:} \href{https://github.com/CRAFT-THU/BSim}{github.com/CRAFT-THU/BSim}
\end{tcolorbox}
\subsection*{CARLsim Research Notes}\label{CARLsim}
...
While CARLsim does not natively support neuromorphic hardware, it integrates cycle-accurate models of hardware like TrueNorth, Loihi, and DynapSE into PyCARL for hardware-software co-simulation. This allows for the simulation of large-scale networks and the exploration of hardware-software interactions. Additionally, CARLsim 6 supports multi-core computers and GPUs, significantly improving its ability to simulate complex networks efficiently. The introduction of support for LIF neurons in CARLsim 5 and the continued development of its biologically realistic modeling capabilities make CARLsim a valuable tool for advancing the field of neuromorphic computing.

\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=CARLsim at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Izhikevich, Leaky Integrate-and-Fire

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Glutamatergic Synapses (E-STDP), GABAergic Synapses (I-STDP), Dopamine-modulated STDP (DA-STDP), Evolutionary Parameter Tuning, Short-Term Plasticity (STP)  

\textbf{Targeted Hardware:} CPU, GPU 

\textbf{Source Code:} \href{https://github.com/UCI-CARL/CARLsim6}{github.com/UCI-CARL/CARLsim6}
\end{tcolorbox}
\subsection*{cuSNN Research Notes}\label{cuSNN}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=cuSNN at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Adaptive Integrate-and-Fire

\textbf{Learning Methods:} Static Synapse (No Learning), Spike Timing Dependant Plasticity (STDP)  

\textbf{Targeted Hardware:} GPU 

\textbf{Source Code:} \href{https://github.com/tudelft/cuSNN}{github.com/tudelft/cuSNN}
\end{tcolorbox}
\subsection*{Doryta Research Notes}\label{Doryta}
...
The Doryta simulator uses the ROSS parallel simulation engine and supports models trained in Whetstone, although creating custom translation procedures for Doryta can be costly due to the lack of standardized frontends. The paper also emphasizes the importance of optimizing interconnects between neurons in spintronic chips, as energy consumption is largely driven by interconnects rather than the neurons themselves. While Doryta's primary focus is on spintronic hardware, its potential for future integration with other frameworks like PyNN could enhance its accessibility and broaden its use in neuromorphic computing research.

\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Doryta at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]
...
\textbf{Source Code:} \href{https://github.com/helq/doryta}{github.com/helq/doryta}
\end{tcolorbox}
\subsection*{EDLUT Research Notes}\label{EDLUT}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=EDLUT at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Hodgkin–Huxley, Izhikevich

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Static Synapse (No Learning)  

\textbf{Targeted Hardware:} GPU, CPU 

\textbf{Source Code:} \href{https://github.com/EduardoRosLab/edlut}{github.com/EduardoRosLab/edlut}
\end{tcolorbox}
\subsection*{Emergent Research Notes}\label{Emergent}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Emergent at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leabra

\textbf{Learning Methods:} Leabra  

\textbf{Targeted Hardware:} CPU, GPU 

\textbf{Source Code:} \href{https://github.com/emer/emergent}{github.com/emer/emergent}
\end{tcolorbox}
\subsection*{ENLARGE Research Notes}\label{ENLARGE}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=ENLARGE at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Static Synapse (No Learning)  

\textbf{Targeted Hardware:} GPU, GPU Cluster 

\textbf{Source Code:} \href{https://github.com/yhx/enlarge}{github.com/yhx/enlarge}
\end{tcolorbox}
\subsection*{Fugu Research Notes}\label{Fugu}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Fugu at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Static Synapse (No Learning)  

\textbf{Targeted Hardware:} CPU, NIR 

\textbf{Source Code:} \href{https://github.com/sandialabs/Fugu}{github.com/sandialabs/Fugu}
\end{tcolorbox}
\subsection*{Genesis Research Notes}\label{Genesis}

The GENESIS simulator, first referenced in 1994 and widely recognized in the neuroscience community, has accumulated over 1600 citations, including notable works such as HRLsim (2013), various versions of CARLsim, and Dendrify (2023). Its latest release, version 2.4, was published in 2019, indicating that while there has not been active development recently, its influence on spiking neural network (SNN) simulation is still profound. GENESIS was initially detailed in The Book of Genesis (1998, re-released in 2012), which has played a significant role in shaping the field over the past three decades, justifying its inclusion in this review despite the time gap since the last update.
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Genesis at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Hodgkin–Huxley, Multi-compartment

\textbf{Learning Methods:} Basic Hebbian  

\textbf{Targeted Hardware:} CPU 

\textbf{Source Code:} \href{https://github.com/genesis-sim/genesis-2.4}{github.com/genesis-sim/genesis-2.4}
\end{tcolorbox}
\subsection*{GeNN Research Notes}\label{GeNN}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=GeNN at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Hodgkin–Huxley, Izhikevich, Equation-based, Kulkov Map

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP)  

\textbf{Targeted Hardware:} CPU, GPU 

\textbf{Source Code:} \href{https://github.com/genn-team/genn}{github.com/genn-team/genn}
\end{tcolorbox}
\subsection*{jaxSNN Research Notes}\label{jaxSNN}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=jaxSNN at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Static Synapse (No Learning), EventProp  

\textbf{Targeted Hardware:} CPU, BrainScaleS 

\textbf{Source Code:} \href{https://github.com/electronicvisions/jaxsnn}{github.com/electronicvisions/jaxsnn}
\end{tcolorbox}
\subsection*{Lava Research Notes}\label{Lava}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Lava at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP)  

\textbf{Targeted Hardware:} CPU, Loihi, NIR 

\textbf{Source Code:} \href{https://github.com/lava-nc/lava}{github.com/lava-nc/lava}
\end{tcolorbox}
\subsection*{Memristor-Spikelearn Research Notes}\label{Memristor-Spikelearn}

The Memristor-Spikelearn simulator is an open-source tool designed to study synaptic plasticity in spiking neural networks by incorporating detailed memristor and circuit models for more accurate simulations. It addresses the challenge that the change in conductance (delta G) of a memristor depends on both the voltage and the current conductance, which may not always match the desired learning pattern. The simulator emphasizes the importance of using detailed device models to ensure that simulations yield realistic results, helping to avoid misleading conclusions. The research also explores how circuit structures, such as 1R and 1T1R configurations, can impact the tradeoff between energy efficiency and accuracy in training and inference tasks.
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Memristor-Spikelearn at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Reward-Modulated (M-STDP) (R-STDP)  

\textbf{Targeted Hardware:} CPU 

\textbf{Source Code:} 

\href{https://github.com/YLab-UChicago/Memristor-Spikelearn}{github.com/YLab-UChicago/Memristor-Spikelearn}
\end{tcolorbox}
\subsection*{N2S3 Research Notes}\label{N2S3}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=N2S3 at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Short-Term Plasticity (STP)  

\textbf{Targeted Hardware:} CPU, Synapse Box 

\textbf{Source Code:} 

\href{https://sourcesup.renater.fr/wiki/n2s3/downloads}{sourcesup.renater.fr/wiki/n2s3/downloads}

\href{https://git.renater.fr/anonscm/git/n2s3/n2s3.git}{git.renater.fr/anonscm/git/n2s3/n2s3.git}
\end{tcolorbox}
\subsection*{Nengo Research Notes}\label{Nengo}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Nengo at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Izhikevich, Adaptive Integrate-and-Fire

\textbf{Learning Methods:} PES, RLS, BCM, OJA, VOJA, Spike Timing Dependant Plasticity (STDP)  

\textbf{Targeted Hardware:} CPU, GPU, SpiNNaker, FPGA, NIR, Loihi 

\textbf{Source Code:} 

\href{https://www.nengo.ai}{www.nengo.ai}

\href{https://github.com/nengo/nengo-loihi}{github.com/nengo/nengo-loihi}
\end{tcolorbox}
\subsection*{NengoDL Research Notes}\label{NengoDL}
...
One of NengoDL's key features is its ability to combine DNNs and SNNs within the same model, such as processing images with a convolutional neural network (CNN) and passing the output to an SNN. It takes advantage of TensorFlow’s hardware support for both CPU and GPU, as well as its performance optimizations. While NengoDL shows great promise for integrating deep learning and neuromorphic models, its limitations in terms of flexibility for custom neuron dynamics and the need for custom neurons to be supported by the NengoDL backend make it less suitable for highly specialized simulation needs, such as those in the ENDS lab.

\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=NengoDL at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Izhikevich, Adaptive Integrate-and-Fire

\textbf{Learning Methods:} PES, RLS, BCM, OJA, VOJA, Surrogate Gradient Back Propogation, Standard Error Back Propogation, ANN-to-SNN Conversion  

\textbf{Targeted Hardware:} CPU, GPU 

\textbf{Source Code:} \href{https://github.com/nengo/nengo-dl}{github.com/nengo/nengo-dl}
\end{tcolorbox}
\subsection*{NEST Research Notes}\label{NEST}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=NEST at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Izhikevich, Adaptive Integrate-and-Fire, Hodgkin–Huxley, Multi-compartment, Adaptive Exponential  Integrate-and-Fire (aEIF), Equation-based

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Basic Hebbian, Static Synapse (No Learning), Short-Term Plasticity (STP), Triplet STDP, EventProp, Equation-based  

\textbf{Targeted Hardware:} CPU 

\textbf{Source Code:} 

\href{https://www.nest-simulator.org/}{www.nest-simulator.org/}

\href{https://github.com/nest/nest-simulator}{github.com/nest/nest-simulator}
\end{tcolorbox}
\subsection*{NEST GPU Research Notes}\label{NEST GPU}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=NEST GPU at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Adaptive Exponential  Integrate-and-Fire (aEIF), Izhikevich, Equation-based

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Equation-based  

\textbf{Targeted Hardware:} GPU 

\textbf{Source Code:} \href{https://github.com/nest/nest-gpu}{github.com/nest/nest-gpu}
\end{tcolorbox}
\subsection*{Neuron Research Notes}\label{Neuron}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Neuron at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Hodgkin–Huxley, Integrate-and-Fire, Multi-compartment

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP)  

\textbf{Targeted Hardware:} CPU 

\textbf{Source Code:} \href{https://github.com/neuronsimulator/nrn}{github.com/neuronsimulator/nrn}
\end{tcolorbox}
\subsection*{NeuroPack Research Notes}\label{NeuroPack}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=NeuroPack at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Izhikevich

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Surrogate Gradient Back Propogation  

\textbf{Targeted Hardware:} CPU 

\textbf{Source Code:} \href{https://github.com/hjq310/NeuroPack}{github.com/hjq310/NeuroPack}
\end{tcolorbox}
\subsection*{NEUTRAMS Research Notes}\label{NEUTRAMS}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=NEUTRAMS at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} ANN-to-SNN Conversion, Static Synapse (No Learning)  

\textbf{Targeted Hardware:} CPU, TIANJI, PRIME 

\textbf{Source Code:} \href{https://github.com/hoangt/neutrams}{github.com/hoangt/neutrams}
\end{tcolorbox}
\subsection*{Norse Research Notes}\label{Norse}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Norse at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Integrate-and-Fire, Izhikevich, Recurrent LIF

\textbf{Learning Methods:} Surrogate Gradient Back Propogation, Back Propogation Through Time (BPTT)  

\textbf{Targeted Hardware:} NIR, CPU, GPU 

\textbf{Source Code:} 

\href{https://norse.github.io/norse}{norse.github.io/norse}

\href{https://github.com/norse/norse}{github.com/norse/norse}
\end{tcolorbox}
\subsection*{PymoNNto Research Notes}\label{PymoNNto}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=PymoNNto at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Izhikevich, Diesmann, Brunel and Hakim, Wang and Buzsáki, Hindmarsh and Rose, Hopfield, Hodgkin–Huxley

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Synaptic Weight normalization, Intrinsic Plasticity, Refractory Period, NOX diffusion-based homeostasis, Evolutionary Parameter Tuning  

\textbf{Targeted Hardware:} GPU, CPU 

\textbf{Source Code:} \href{https://github.com/trieschlab/PymoNNto}{github.com/trieschlab/PymoNNto}
\end{tcolorbox}
\subsection*{PymoNNtorch Research Notes}\label{PymoNNtorch}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=PymoNNtorch at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]
...
\textbf{Source Code:} \href{https://github.com/cnrl/PymoNNtorch}{github.com/cnrl/PymoNNtorch}
\end{tcolorbox}
\subsection*{PySNN Research Notes}\label{PySNN}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=PySNN at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Integrate-and-Fire, Adaptive Integrate-and-Fire

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Reward-Modulated Elegibility Trace (M-STDP-ET) (R-STDP)  

\textbf{Targeted Hardware:} GPU, CPU 

\textbf{Source Code:} \href{https://github.com/BasBuller/PySNN}{github.com/BasBuller/PySNN}
\end{tcolorbox}
\subsection*{RANC Research Notes}\label{RANC}

RANC is a versatile toolkit that integrates both software simulation and hardware emulation for Spiking Neural Networks (SNNs), providing both a software simulator and an FPGA-based simulator. TensorFlow is used for model definition and training, with subsequent preparation for RANC simulation via libraries that interface with TensorFlow. One key constraint is the requirement to use synaptic connection probabilities rather than weights, enabling the use of backpropagation for training. However, for forward propagation, these probabilities must be converted to binary values (0 or 1). The system offers a high degree of customization in neuron behavior through configuration parameters, though changes in network topology may require significant modifications to the simulators.
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=RANC at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Synaptic Connection Probability Back Propogation  

\textbf{Targeted Hardware:} CPU, FPGA 

\textbf{Source Code:} \href{https://github.com/UA-RCL/RANC}{github.com/UA-RCL/RANC}
\end{tcolorbox}
\subsection*{RAVSim Research Notes}\label{RAVSim}
...
The research paper highlights RAVSim's capabilities for image classification tasks, such as achieving 91.8% accuracy in classifying faces with and without masks using the Leaky Integrate-and-Fire (LIF) model. The simulator offers both deterministic and stochastic analyses, allowing for real-time exploration of parameter settings. Its user-friendly interface and scalable dataset creation make it an attractive tool for researchers, although its claims about image processing and learning capabilities raise questions about the accuracy of its comparison with other models.

\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=RAVSim at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]
...
\textbf{Source Code:} \href{https://github.com/Rao-Sanaullah/RAVSim}{github.com/Rao-Sanaullah/RAVSim}
\end{tcolorbox}
\subsection*{SaRNN Research Notes}\label{SaRNN}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=SaRNN at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Integrate-and-Fire

\textbf{Learning Methods:} ANN-to-SNN Conversion  

\textbf{Targeted Hardware:} CPU, SpiNNaker 

\textbf{Source Code:} \href{https://github.com/WISION-Lab/sarnn}{github.com/WISION-Lab/sarnn}
\end{tcolorbox}
\subsection*{SINABS Research Notes}\label{SINABS}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=SINABS at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Integrate-and-Fire, Leaky Integrate-and-Fire

\textbf{Learning Methods:} ANN-to-SNN Conversion, Surrogate Gradient Back Propogation, Back Propogation Through Time (BPTT)  

\textbf{Targeted Hardware:} CPU, Speck 

\textbf{Source Code:} \href{https://github.com/synsense/sinabs}{github.com/synsense/sinabs}
\end{tcolorbox}
\subsection*{SNNToolbox Research Notes}\label{SNNToolbox}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=SNNToolbox at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]
...
\href{https://github.com/NeuromorphicProcessorProject/snn_toolbox}{github.com/NeuromorphicProcessorProject/snn\_toolbox}
\end{tcolorbox}
\subsection*{snnTorch Research Notes}\label{snnTorch}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=snnTorch at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Recurrent LIF, Lapicque, Recurrent Synaptic, Synaptic, Alpha, SLSTM

\textbf{Learning Methods:} Surrogate Gradient Back Propogation, Back Propogation Through Time (BPTT)  

\textbf{Targeted Hardware:} CPU, GPU, NIR, Graphcore Intelligence Processing Unit (IPU) 

\textbf{Source Code:} \href{https://github.com/jeshraghian/snntorch}{github.com/jeshraghian/snntorch}
\end{tcolorbox}
\subsection*{SPAIC Research Notes}\label{SPAIC}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=SPAIC at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Hodgkin–Huxley, Izhikevich, Adaptive Exponential  Integrate-and-Fire (aEIF)

\textbf{Learning Methods:} Spike Timing Dependant Plasticity (STDP), Surrogate Gradient Back Propogation, Reward-Modulated (M-STDP) (R-STDP), FORCE Training (Reservoir Computing), SpikeProp  

\textbf{Targeted Hardware:} CPU, GPU 

\textbf{Source Code:} \href{https://github.com/zju-bmi-lab/SPAIC}{github.com/zju-bmi-lab/SPAIC}
\end{tcolorbox}
\subsection*{SPIKE Research Notes}\label{SPIKE}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=SPIKE at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]
...
\textbf{Source Code:} \href{https://github.com/OFTNAI/Spike}{github.com/OFTNAI/Spike}
\end{tcolorbox}
\subsection*{SpikingJelly Research Notes}\label{SpikingJelly}
...
SpikingJelly accelerates the training of deep SNNs by 11x, offering flexibility for custom models and supporting multilevel inheritance and semiautomatic code generation. The platform enables efficient deployment of SNNs on neuromorphic chips and enhances performance in real-world applications, from basic dataset classification to human-level tasks. It provides tools for preprocessing neuromorphic datasets, building deep SNNs, optimizing parameters, and deploying them on neuromorphic hardware. The framework also includes modules for spiking neurons, layer-by-layer propagation, and CUDA code generation, contributing to the growing field of spiking deep learning.

\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=SpikingJelly at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire, Integrate-and-Fire

\textbf{Learning Methods:} Surrogate Gradient Back Propogation, Back Propogation Through Time (BPTT), ANN-to-SNN Conversion, Spike Timing Dependant Plasticity (STDP)  

\textbf{Targeted Hardware:} CPU, GPU, Loihi, Tianjic Lynxi KA200 

\textbf{Source Code:} \href{https://github.com/fangwei123456/spikingjelly}{github.com/fangwei123456/spikingjelly}
\end{tcolorbox}
\subsection*{SpykeTorch Research Notes}\label{SpykeTorch}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=SpykeTorch at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]
...
\textbf{Source Code:} \href{https://github.com/miladmozafari/SpykeTorch}{github.com/miladmozafari/SpykeTorch}
\end{tcolorbox}
\subsection*{Spyx Research Notes}\label{Spyx}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=Spyx at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]

\textbf{Neuron Models:} Leaky Integrate-and-Fire

\textbf{Learning Methods:} Surrogate Gradient Back Propogation  

\textbf{Targeted Hardware:} GPU, NIR 

\textbf{Source Code:} \href{https://github.com/kmheckel/spyx}{github.com/kmheckel/spyx}
\end{tcolorbox}
\subsection*{SuperNeuro Research Notes}\label{SuperNeuro}
...
\begin{tcolorbox}[enhanced,attach boxed title to top center={yshift=-3mm,yshifttext=-1mm}, colback=blue!5!white,colframe=blue!75!black,colbacktitle=red!80!black, title=SuperNeuro at a Glance,fonttitle=\bfseries, boxed title style={size=small,colframe=red!50!black} ]
...
\href{https://github.com/ORNL/superneuro}{github.com/ORNL/superneuro}

\href{https://github.com/ORNL/superneuromat}{github.com/ORNL/superneuromat}

\href{https://github.com/ORNL/superneuroabm}{github.com/ORNL/superneuroabm}
\end{tcolorbox}
